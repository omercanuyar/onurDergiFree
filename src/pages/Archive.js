...
export default function Archive() {
    ...
    const staticMagazines = [
        ...
        { id: 8, title: '', issue: 'Sayı 9', date: 'Ocak 2020', cover: coverTibbiye9, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli9.pdf" },
        { id: 9, title: '', issue: 'Sayı 10', date: 'Mart 2020', cover: coverTibbiye10, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli10.pdf" },
        { id: 10, title: '', issue: 'Sayı 11', date: 'Eylül 2020', cover: coverTibbiye11, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli11.pdf" },
        { id: 11, title: '', issue: 'Sayı 13', date: 'Eylül 2021', cover: coverTibbiye13, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli13.pdf" },
        { id: 12, title: '', issue: 'Sayı 14', date: 'Mayıs 2022', cover: coverTibbiye14, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli14.pdf" },
        { id: 13, title: '', issue: 'Sayı 15', date: 'Ekim 2022', cover: coverTibbiye15, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli15.pdf" },
        { id: 14, title: '', issue: 'Sayı 16', date: 'Nisan 2023', cover: coverTibbiye16, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli16.pdf" },
        { id: 15, title: '', issue: 'Sayı 17', date: 'Ekim 2023', cover: coverTibbiye17, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli17.pdf" },
        { id: 16, title: '', issue: 'Sayı 18', date: 'Mayıs 2024', cover: coverTibbiye18, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli18.pdf" },
        { id: 17, title: '', issue: 'Sayı 19', date: 'Kasım 2024', cover: coverTibbiye19, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli19.pdf" },
        { id: 18, title: '', issue: 'Sayı 20', date: 'Mayıs 2025', cover: coverTibbiye20, pdf: process.env.PUBLIC_URL + "/journals/tibbiyeli20.pdf" },
    ];
